...
export const selectCommentsPagesCount = (state: RootState) => state.forum.commentsPagesCount;
export const selectActiveTopicsPage = (state: RootState) => state.forum.activeTopicsPage;
export const selectActiveCommentsPage = (state: RootState) => state.forum.activeCommentsPage;
